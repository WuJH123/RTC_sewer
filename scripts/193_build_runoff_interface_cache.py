...
from sewerrtc.state.interface_cache import build_runoff_interface_cache
...
def main() -> int:
    ...
    code, outputs = build_runoff_interface_cache(args.config, args.max_events, Path(args.out_dir))
